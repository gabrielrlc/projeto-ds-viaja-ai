...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col">
      ...
      <header className="w-full h-20 px-8 flex items-center justify-between z-50 bg-white/10 backdrop-blur-md border-b border-white/20">
        ...
        <div className="grid grid-cols-2 gap-12 items-start min-h-[70vh]">
          <div className="relative bg-secondary h-150 w-100 ml-50 px-8 pt-0 pb-8 rounded-2xl shadow-2xl flex flex-col gap-6">
            ...
            <div className="mt-auto flex flex-col items-center gap-2">
              <Link href="/login?aba=registro"><Button size="lg" className="h-12 px-4 font-medium">Cadastre-se e planeje <ArrowRight /></Button></Link>
